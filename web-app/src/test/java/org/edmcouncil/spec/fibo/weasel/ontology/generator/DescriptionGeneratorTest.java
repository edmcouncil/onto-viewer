...
import static org.edmcouncil.spec.fibo.weasel.ontology.generator.DescriptionGenerator.IS_A_RESTRICTIONS_INHERITED_LABEL;
import static org.edmcouncil.spec.fibo.weasel.ontology.generator.DescriptionGenerator.IS_A_RESTRICTIONS_LABEL;
import static org.edmcouncil.spec.fibo.weasel.ontology.generator.DescriptionGenerator.ONTOLOGICAL_CHARACTERISTIC_LABEL;
...
class DescriptionGeneratorTest {
  ...
  private OwlTaxonomyImpl prepareTaxonomy(List<List<String>> rawListOfTaxonomies) {
    OwlTaxonomyImpl owlTaxonomy = new OwlTaxonomyImpl();
