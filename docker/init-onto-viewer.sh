...
exec java ${UPDATE_URL:+ -Dapp.config.ontologies.download_directory=download -Dapp.config.updateUrl=${UPDATE_URL}} -jar app.war --server.servlet.context-path=/${ONTPUB_FAMILY:-dev}/ontology --app.defaultHomePath="$INIT_DIR/app_home"
